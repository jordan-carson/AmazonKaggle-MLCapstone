...
The benchmark model will be a CNN however, I will run several different CNN networks through Keras such as DenseNet, ResNet-101, ResNet-152, SqueezeNet, Inception, VGG16, VGG19 and other keras models to compare which yields the best result as each engineers their features slightly differently.
